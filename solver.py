import sys, utils.file_functions, graphs.graph_struct, uninformed_search_functions, informed_search_functions, heuristic
...
if sys.argv[1] == "-u":
    algorithm_result = uninformed_search_functions.breath_search(problem_obj, launch_obj)
else:
    algorithm_result = informed_search_functions.a_star_search(problem_obj, launch_obj, heuristic.heuristic_2)
