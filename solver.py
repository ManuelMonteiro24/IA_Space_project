import sys, copy, utils.file_functions, strategy.queue_data, uniformed_search_function_fast_update, graphs.graph_struct
...
if sys.argv[1] == "-u":
    ...
    algorithm_result = uniformed_search_function_fast_update.general_search(problem_obj,strategy_obj, launch_obj)
else:
    print("informed TODO...")
